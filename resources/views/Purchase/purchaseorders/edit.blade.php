    ...
    <form method="POST" action="{{ route('purchase.update', $po->id) }}">
        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="company" class="form-select">
                            ...
                            <option value="Arasuvel Roofings" {{ $po->company == 'Arasuvel Roofings' ? 'selected' : '' }}>
                ...
                @elseif($po->po_template == 'metalsheet')
                @include('Purchase.purchaseorders.edittemplates.metalsheet')
                @endif
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" id="gst_percent" name="gst_percent" class="form-control" value="{{ $po->gst_percent }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" id="grand_total" name="grand_total" class="form-control" value="{{ $po->grand_total }}" readonly>

    ...
    <div class="app-layout">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="#" class="active">
                    <i class="bi bi-file-earmark-text"></i> Leads <span
                        class="badge text-bg-danger">{{ $lc }}</span>
                </a>
                                    ...
                                    @foreach ($leadSC as $status => $count)
                                        <div class="col-xl-3 col-lg-4 col-md-6">
                                            <div class="modern-card">
                                                <div
                                                    class="icon-box text-{{ $statusData[$status]['color'] ?? 'primary' }}">

                                                    <i
                                                        class="bi {{ $statusData[$status]['icon'] ?? 'bi-circle' }}"></i>
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div
                                                        class="status-line bg-{{ $statusData[$status]['color'] ?? 'primary' }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                                            ...
                                            <div class="source-card">
                                                ...
                                                <div class="source-icon"
                                                    style="color:{{ $sourceData[$source]['color'] ?? '#2563eb' }}">

                                                    <i
                                                        class="bi {{ $sourceData[$source]['icon'] ?? 'bi-folder' }}"></i>
                                                ...
                                                <div class="source-line"
                                                    style="background:{{ $sourceData[$source]['color'] ?? '#2563eb' }}">
                                                </div>
                                ...
                                <div class="table table-responsive">
                                    ...
                                    <table class="table table-bordered table-hover align-middle">
                                        ...
                                        <tbody>
                                            @foreach ($lds as $leds)
                                                <tr
                                                    class="@if (strtolower($leds->Status) == 'cancelled') table-danger
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center gap-1">
                                                            <button class="btn btn-primary" data-bs-toggle="modal"
                                                                ...
                                                                data-lead-id="{{ $leds->id }}">
                                                                Feedback
                                                            </button>
                                                            <button class="btn btn-primary btn-sm"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#timelineModal{{ $leds->id }}"
                                                                data-lead-id="{{ $leds->id }}">
                                                                Timeline
                                                            </button>
                                                        </div>
                                                ...
                                                <div class="modal fade" id="timelineModal{{ $leds->id }}"
                                                    tabindex="-1">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="timeline">
                                                                            ...
                                                                            @if (!empty($leds->Description))
                                                                                <div class="timeline-item">
                                                                                    <span
                                                                                        class="timeline-dot bg-info"></span>
                                                                                    <div class="timeline-card">
                                                                                        <strong>Initial
                                                                                            Enquiry</strong><br>
                                                                                        <span class="timeline-date">
                                                                            ...
                                                                            @forelse($leds->feedbacks as $fb)
                                                                                <div class="timeline-item">
                                                                                    <span
                                                                                        class="timeline-dot bg-success"></span>
                                                                                    <div class="timeline-card">
